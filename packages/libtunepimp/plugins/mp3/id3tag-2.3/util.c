 ...
 *
 * $Id: util.c 1373 2005-05-24 05:29:15Z robert $
 */
 ...
 */
id3_2_3_length_t id3_2_3_util_unsynchronise(id3_2_3_byte_t *data, id3_2_3_length_t length)
{
  id3_2_3_length_t bytes = 0, count;
  id3_2_3_byte_t *end = data + length;
 ...
 */
id3_2_3_length_t id3_2_3_util_deunsynchronise(id3_2_3_byte_t *data, id3_2_3_length_t length)
{
  id3_2_3_byte_t const *old, *end = data + length;
  id3_2_3_byte_t *new;
 ...
 */
id3_2_3_byte_t *id3_2_3_util_compress(id3_2_3_byte_t const *data, id3_2_3_length_t length,
			      id3_2_3_length_t *newlength)
{
  id3_2_3_byte_t *compressed;
 ...
 */
id3_2_3_byte_t *id3_2_3_util_decompress(id3_2_3_byte_t const *data, id3_2_3_length_t length,
				id3_2_3_length_t newlength)
{
  id3_2_3_byte_t *decompressed;
